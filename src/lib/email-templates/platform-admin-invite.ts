...
export function renderPlatformAdminInvite(
  ...
  const body = /* html */ `
    ...
    <p style="margin: 0 0 8px; color: #C8CFE6; font-size: 15px; line-height: 1.6;">
      ...
      <strong style="color: #FFFFFF;">admin.leadey.ai</strong> — the control panel
    ...
    <p style="margin: 0 0 24px; color: #97A4D6; font-size: 13px; line-height: 1.6;">
    ...
    <ul style="margin: 0 0 0 0; padding: 0; list-style: none; color: #C8CFE6; font-size: 14px; line-height: 1.6;">
...
function bullet(text: string): string {
  return /* html */ `
    <li style="padding: 6px 0; padding-left: 18px; position: relative;">
      <span style="position: absolute; left: 0; top: 6px; color: #97A4D6; font-weight: 600;">·</span>
      ${escapeHtml(text)}
    </li>`;
}
